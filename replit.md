...
- **Dashboard Aquarela**: Simplified to clean sidebar-based design with aquarela gradient background (#e0eafc, #cfdef3), white sidebar navigation for medical functions, and minimalist layout focused on essential medical workflow navigation
