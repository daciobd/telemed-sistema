...
// ===== FASE 2 - PÁGINAS INSTITUCIONAIS CRÍTICAS =====

// 1. SOBRE NÓS
app.get('/sobre', (req, res) => {
  console.log('📄 Serving sobre (FASE 2) for:', req.path);
  res.send(`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            @media (max-width: 768px) {
                ...
                .header p { font-size: 18px; }
                .container { padding: 60px 20px; }
                .stats-hero { grid-template-columns: repeat(2, 1fr); gap: 20px; }
    ...
    <body>
        ...
        <div class="header">
            <h1>Sobre a TeleMed</h1>
            <p>Revolucionando o acesso à saúde com tecnologia, inovação e cuidado humano</p>
        </div>
        ...
        <div class="container">
            ...
            <div class="stats-hero">
                <div class="stat-card">
                    ...
                    <span class="stat-label">Médicos Credenciados</span>
                </div>
                <div class="stat-card">
                    <span class="stat-number">100K+</span>
                    <span class="stat-label">Consultas Realizadas</span>
            ...
            <div class="content-section">
                ...
                <p class="section-text">
                    Democratizar o acesso à saúde de qualidade através da tecnologia, conectando pacientes e médicos de forma rápida, segura e acessível. Acreditamos que cuidar da saúde não deve ser um privilégio, mas um direito fundamental de todos.
                </p>
            </div>
            
            <!-- CTA Final -->
            <div class="cta-section">
                <h2 style="font-size: 32px; margin-bottom: 20px; font-weight: 700;">Faça Parte da Nossa História</h2>
                <p style="font-size: 18px; margin-bottom: 20px;">Junte-se a milhares de pessoas que já confiam na TeleMed para cuidar da sua saúde</p>
                <div class="cta-buttons">
                    <a href="/dr-ai" class="cta-button">Teste o Dr. AI Grátis</a>
                    <a href="/patient-bidding" class="cta-button">Fazer Minha Primeira Consulta</a>
                </div>
            </div>
        </div>
    </body>
...
app.get('/politica-privacidade', (req, res) => {
  console.log('📄 Serving politica-privacidade (FASE 2) for:', req.path);
  res.send(`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
    ...
    <body>
        ...
        <div class="header">
            <h1>Política de Privacidade</h1>
            <p>Conformidade LGPD e proteção total dos seus dados médicos</p>
        </div>
        
        <div class="container">
            <div class="lgpd-badge">
                🔒 100% CONFORMIDADE LGPD (Lei 13.709/2018) • Atualizada em 29 de julho de 2025
            </div>
            
            <div class="section">
                <h2 class="section-title">1. Dados Que Coletamos</h2>
                
                <div class="subsection">
                    <h3 class="subsection-title">1.1 Dados Pessoais</h3>
                    <ul class="list">
                        <li>Nome completo, CPF, e-mail e telefone</li>
                        <li>Data de nascimento e endereço</li>
                        <li>Informações médicas e histórico de saúde</li>
                        <li>Dados de pagamento (processados por terceiros seguros)</li>
                    </ul>
                </div>
                
                <div class="subsection">
                    <h3 class="subsection-title">1.2 Dados Profissionais (Médicos)</h3>
                    <ul class="list">
                        <li>CRM e especialização médica</li>
                        <li>Formação acadêmica e experiência</li>
                        <li>Avaliações e estatísticas de atendimento</li>
                    </ul>
                </div>
                
                <div class="subsection">
                    <h3 class="subsection-title">1.3 Dados Técnicos</h3>
                    <ul class="list">
            ...
            <div class="section">
                <h2 class="section-title">2. Finalidades do Tratamento</h2>
                <p class="section-text">Utilizamos seus dados exclusivamente para:</p>
                <ul class="list">
                    <li>Prestação de serviços de telemedicina</li>
                    <li>Comunicação entre médicos e pacientes</li>
                    <li>Processamento de pagamentos</li>
                    <li>Melhorias no atendimento e na plataforma</li>
            ...
            <div class="section">
                <h2 class="section-title">3. Seus Direitos LGPD</h2>
                <div class="highlight-box">
                    <p><strong>Você tem direito a:</strong></p>
                </div>
                
                <div class="subsection">
                    <h3 class="subsection-title">3.1 Acesso aos Dados</h3>
                    <p class="section-text">Consultar quais dados pessoais possuímos sobre você</p>
                </div>
                
                <div class="subsection">
                    <h3 class="subsection-title">3.2 Correção</h3>
                    <p class="section-text">Corrigir dados incompletos, inexatos ou desatualizados</p>
                </div>
                
                <div class="subsection">
                    <h3 class="subsection-title">3.3 Exclusão</h3>
                    <p class="section-text">Solicitar a exclusão de dados pessoais (observadas as obrigações legais médicas)</p>
                </div>
                
                <div class="subsection">
                    <h3 class="subsection-title">3.4 Portabilidade</h3>
                    <p class="section-text">Receber seus dados em formato estruturado para transferência</p>
                </div>
                
                <div class="subsection">
                    <h3 class="subsection-title">3.5 Oposição</h3>
                    <p class="section-text">Opor-se ao tratamento de dados em situações específicas</p>
                </div>
            </div>
            
            <div class="section">
                <h2 class="section-title">4. Segurança e Proteção</h2>
                
                <div class="subsection">
                    <h3 class="subsection-title">4.1 Medidas Técnicas</h3>
                    <ul class="list">
                ...
                <div class="subsection">
                    <h3 class="subsection-title">4.2 Medidas Organizacionais</h3>
                    <ul class="list">
                        <li>Treinamento regular da equipe em proteção de dados</li>
                        <li>Controles rigorosos de acesso às informações</li>
                        <li>Políticas internas de segurança da informação</li>
                        <li>Auditoria regular dos processos de segurança</li>
                    </ul>
                </div>
            </div>
            
            <div class="section">
                <h2 class="section-title">5. Retenção de Dados</h2>
                
                <div class="subsection">
                    <h3 class="subsection-title">5.1 Dados Médicos</h3>
                    <p class="section-text">
                        Mantidos conforme Resolução CFM nº 1.821/2007: mínimo de 10 anos para adultos 
                        e até 25 anos para menores de idade (ou 5 anos após atingir maioridade).
                    </p>
                </div>
                
                <div class="subsection">
                    <h3 class="subsection-title">5.2 Dados Pessoais</h3>
                    <p class="section-text">
                        Mantidos apenas durante o período necessário para as finalidades descritas, 
                        respeitando prazos legais mínimos.
                    </p>
                </div>
                
                <div class="subsection">
                    <h3 class="subsection-title">5.3 Exclusão Automática</h3>
                    <p class="section-text">
                        Sistema automatizado para exclusão de dados após vencimento dos prazos de retenção.
                    </p>
                </div>
            </div>
            
            <div class="section">
                <h2 class="section-title">6. Compartilhamento de Dados</h2>
                <p class="section-text">Seus dados médicos são compartilhados apenas:</p>
                <ul class="list">
                    <li>Com o médico responsável pela sua consulta</li>
                    <li>Com prestadores de serviços essenciais (sob rigoroso contrato de confidencialidade)</li>
                    <li>Quando exigido por lei ou autoridade competente</li>
                    <li>NUNCA vendemos ou cedemos dados para terceiros para fins comerciais</li>
                </ul>
            </div>
...
app.get('/precos', (req, res) => {
  console.log('📄 Serving precos (FASE 2) for:', req.path);
  res.send(`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Preços e Planos - TeleMed Sistema</title>
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            body { 
                font-family: 'Poppins', 'Inter', Arial, sans-serif; 
            ...
            .pricing-card:hover {
                transform: translateY(-10px);
                box-shadow: 0 25px 50px rgba(167, 199, 231, 0.15);
            }
            ...
            .plan-button:hover {
                transform: translateY(-2px);
                box-shadow: 0 10px 25px rgba(167, 199, 231, 0.3);
            }
    ...
    <body>
        ...
        <div class="header">
            ...
            <p>Consultas médicas por valores justos, definidos por você através do sistema de lances</p>
        </div>
        
        <div class="container">
            <!-- Sistema de Lances -->
            <div class="bidding-section">
                <h2 class="bidding-title">🎯 Sistema Revolucionário de Lances</h2>
                <p class="bidding-description">
                    Na TeleMed, VOCÊ define quanto quer pagar pela consulta! Nosso sistema de lances permite que você tenha controle total sobre o valor, garantindo transparência e preços justos. Veja as faixas mais comuns por especialidade:
                </p>
                <div class="specialty-grid">
                    <div class="specialty-card">
                        <div class="specialty-name">Clínica Geral</div>
                        <div class="specialty-range">R$ 80 - R$ 120</div>
                        <div class="specialty-note">Consultas básicas</div>
                    </div>
                    <div class="specialty-card">
                        <div class="specialty-name">Cardiologia</div>
                        <div class="specialty-range">R$ 160 - R$ 220</div>
                        <div class="specialty-note">Especialidade cardiovascular</div>
                    </div>
                    <div class="specialty-card">
                        <div class="specialty-name">Dermatologia</div>
                        <div class="specialty-range">R$ 140 - R$ 180</div>
                        <div class="specialty-note">Cuidados da pele</div>
                    </div>
                    <div class="specialty-card">
                        <div class="specialty-name">Psiquiatria</div>
                        <div class="specialty-range">R$ 200 - R$ 300</div>
                        <div class="specialty-note">Saúde mental</div>
                    </div>
                    <div class="specialty-card">
                        <div class="specialty-name">Pediatria</div>
                        <div class="specialty-range">R$ 120 - R$ 160</div>
                        <div class="specialty-note">Cuidados infantis</div>
                    </div>
                    <div class="specialty-card">
                        <div class="specialty-name">Ginecologia</div>
                        <div class="specialty-range">R$ 140 - R$ 200</div>
                        <div class="specialty-note">Saúde da mulher</div>
                    </div>
                    <div class="specialty-card">
                        <div class="specialty-name">Ortopedia</div>
                        <div class="specialty-range">R$ 150 - R$ 220</div>
                        <div class="specialty-note">Ossos e articulações</div>
                    </div>
                    <div class="specialty-card">
                        <div class="specialty-name">Nutrição</div>
                        <div class="specialty-range">R$ 80 - R$ 140</div>
                        <div class="specialty-note">Orientação alimentar</div>
                    </div>
                </div>
            </div>
            ...
            <div class="pricing-section">
                <h2 class="section-title">Planos Especiais (Opcional)</h2>
                <div class="pricing-grid">
                    <div class="pricing-card">
                        ...
                        <ul class="plan-features">
                            <li>Sistema de lances ilimitado</li>
                            <li>Dr. AI gratuito</li>
                            <li>Videoconsultas HD</li>
                            <li>Receitas digitais</li>
                            <li>Suporte por email</li>
                        </ul>
                        <a href="/patient-bidding" class="plan-button">Começar Grátis</a>
                    </div>
                    ...
                    <div class="pricing-card featured">
                        ...
                        <ul class="plan-features">
                            ...
                            <li>Prioridade nos lances</li>
                            <li>Histórico médico completo</li>
                            <li>Agendamento preferencial</li>
                            <li>Suporte prioritário</li>
                            <li>Consultas de retorno 50% off</li>
                        </ul>
                        <a href="/patient-bidding" class="plan-button">Assinar Premium</a>
                    </div>
                    
                    <div class="pricing-card">
                        <span class="plan-icon">👑</span>
                        <h3 class="plan-title">Family</h3>
                        <div class="plan-price">R$ 79</div>
                        <div class="plan-period">por mês</div>
                        <ul class="plan-features">
                            <li>Tudo do plano Premium</li>
                            <li>Até 6 membros da família</li>
                            <li>Pediatra dedicado</li>
                            <li>Emergências 24/7</li>
                            <li>Desconto em exames</li>
                            <li>Consultor familiar</li>
                        </ul>
                        <a href="/patient-bidding" class="plan-button">Assinar Family</a>
                    </div>
                </div>
            </div>
        </div>
