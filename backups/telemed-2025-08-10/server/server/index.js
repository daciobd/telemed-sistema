...
async function startServer() {
    ...
    const { Client } = await Promise.resolve().then(() => require('pg'));
    // Get all patients
    ...
    app.patch('/api/pacientes/:id/remarcar', async (req, res) => {
        try {
            const { id } = req.params;
            const { nova_data, nova_hora, motivo, observacoes, data_anterior, hora_anterior } = req.body;
  ...
  `);
    ...
    app.get('/tdah-asrs18', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../tdah-asrs18.html');
    ...
    app.get('/gad7-ansiedade', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../gad7-ansiedade.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
    ...
    app.get('/phq9-depressao', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../phq9-depressao.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
    ...
    app.get('/mdq-bipolar', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../mdq-bipolar.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
    ...
    app.get('/pss10-stress', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../pss10-stress.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
    ...
    app.get('/triagem-psiquiatrica', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../triagem-psiquiatrica.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
    ...
    app.get('/ansiedade-gad7', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../ansiedade-gad7.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
    ...
    app.get('/depressao-phq9', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../depressao-phq9.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
    ...
    app.get('/bipolar-mdq', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../bipolar-mdq.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
    ...
    app.get('/stress-pss10', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../stress-pss10.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
    ...
    app.get('/telemonitoramento', (req, res) => {
        ...
        try {
            const filePath = path_1.default.join(__dirname, '../telemonitoramento-enfermagem.html');
            const htmlContent = fs_1.default.readFileSync(filePath, 'utf8');
            res.send(htmlContent);
        }
        catch (error) {
