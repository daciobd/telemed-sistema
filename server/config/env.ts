...
export const env = z.object({
  ...
  AI_SYMPTOMS_ENABLED: z.string().default("false").transform(v => v === "true"),
  AI_ICD_SUGGESTION_ENABLED: z.string().default("false").transform(v => v === "true"),
  AI_DRUG_INTERACTIONS_ENABLED: z.string().default("false").transform(v => v === "true"),
